...
@startuml
autonumber
HTTP Publisher -> Salesforce : POST /jobs/ingest (create)
Salesforce --> HTTP Publisher : jobId
HTTP Publisher -> Salesforce : PUT /jobs/ingest/{jobId}/batches (CSV/JSONL)
...
HTTP Publisher -> Salesforce : GET /.../successfulResults
HTTP Publisher -> Salesforce : GET /.../failedResults
@enduml
```
